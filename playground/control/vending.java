...
Problem Statement: Read selection (int 1–6) and amountInserted (double). Prices by selection: 1=Water $1.00, 2=Soda $1.50, 3=Juice $2.00, 4=Coffee $1.75, 5=Tea $1.25, 6=EnergyDrink $2.50. Anything else → INVALID SELECTION (ignore amount entirely). If valid: amount ≥ price → <NAME> DISPENSED, CHANGE: X.XX; else → INSERT MORE MONEY.

Input Format: int selection, double amountInserted Output Format: one line Constraints: 0.0 <= amountInserted <= 100.0
